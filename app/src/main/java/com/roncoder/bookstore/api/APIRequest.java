...
public interface APIRequest {
    ...
    @FormUrlEncoded
    @POST("/bookstore/webservice/get/user.php")
    Call<Result> loginExist (@Field("login") String _login);
    ...
    @FormUrlEncoded
    @POST("/bookstore/webservice/get/user.php")
    Call<Result> getUserByEmail (@Field("email") String _email);

    @FormUrlEncoded
    @POST("/bookstore/webservice/get/book.php")
    ...
    @FormUrlEncoded
    @POST("/bookstore/webservice/get/classe.php")
    Call<Result> getCycleClasses (@Field("cycle") String _cycle);

    @FormUrlEncoded
    @POST("/bookstore/webservice/get/Commend.php")
    ...
    @FormUrlEncoded
    @POST("/bookstore/webservice/get/Bill.php")
    ...
    @FormUrlEncoded
    @POST("/bookstore/webservice/get/shippingAddress.php")
    ...
    @FormUrlEncoded
    @POST("/bookstore/webservice/post/user.php")
    ...
    @FormUrlEncoded
    @POST("/bookstore/webservice/post/commend.php")
    Call<Result> addCommend (@Field("book_id") String _book_id, @Field("quantity") int _quantity,
                          @Field("user_id") int _user_id);

    @FormUrlEncoded
    @POST("/bookstore/webservice/post/bill.php")
    Call<Result> addBill (@Field("user_id") int _user_id, @Field("shipping_add_ref") String _shipping_add_ref,
                          @Field("shipping_type") String _shipping_type, @Field("total_prise") float _total_prise);

    @FormUrlEncoded
    @POST("/bookstore/webservice/post/shippingAddress.php")
    Call<Result> addShippingAddress (@Field("receiver_name") String _receiver_name, @Field("phone") String _phone,
                          @Field("district") String _district, @Field("street") String _street,
    ...
    @FormUrlEncoded
    @POST("/bookstore/webservice/update/user.php")
    ...
    @FormUrlEncoded
    @POST("/bookstore/webservice/update/commend.php")
    ...
    @FormUrlEncoded
    @POST("/bookstore/webservice/update/bill.php")
    ...
    @FormUrlEncoded
    @POST("/bookstore/webservice/update/ShippingAddress.php")
    ...
    @FormUrlEncoded
    @POST("/bookstore/webservice/delete/commend.php")
    Call<Result> deleteCommend (@Field("cmd_id") int _cmd_id);

    @FormUrlEncoded
    @POST("/bookstore/webservice/delete/shippingAddress.php")
    Call<Result> deleteShippingAddress (@Field("ship_add_ref") String _shipping_add_ref);

    @FormUrlEncoded
    @POST("/bookstore/webservice/delete/bill.php")
