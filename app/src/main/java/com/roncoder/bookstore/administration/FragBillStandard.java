...
public class FragBillStandard extends Fragment {

    public static final String TAG = "FragBillStandard";
    List<Bill> bills;
    private BillAdapter adapter;
    private View root, progress;

    public FragBillStandard() {}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root = inflater.inflate(R.layout.fragment_frag_cmd_standard, container, false);
    ...
    private void setCommendList() {
        ...
        BillHelper.getBillByShippingType(Utils.SHIPPING_STANDARD)
                .addSnapshotListener((value, error) -> {
                    progress.setVisibility(View.GONE);
                    if (error != null)  {
                        Log.e(TAG, "Error when get the standard commend list : ", error);
                        return;
                    }
