...
public class FragFactureStandard extends Fragment {
...
//                adapter.notifyDataSetChanged();
    ...
    private void setCommendList() {
        ...
        factures.add(new Facture(1, commends, new User(), new ShippingAddress(), Calendar.getInstance().getTime(), Utils.FactureState.STANDARD));
        factures.add(new Facture(1, commends, new User(), new ShippingAddress(), Calendar.getInstance().getTime(), Utils.FactureState.STANDARD));
        factures.add(new Facture(1, commends, new User(), new ShippingAddress(), Calendar.getInstance().getTime(), Utils.FactureState.STANDARD));
        factures.add(new Facture(1, commends, new User(), new ShippingAddress(), Calendar.getInstance().getTime(), Utils.FactureState.STANDARD));
        factures.add(new Facture(1, commends, new User(), new ShippingAddress(), Calendar.getInstance().getTime(), Utils.FactureState.STANDARD));
