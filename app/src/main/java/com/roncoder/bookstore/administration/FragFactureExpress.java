...
public class FragFactureExpress extends Fragment {
    List<Facture> factures;
    private ListView listView;
    private AdminCmdAdapter adapter;
    private View root;
    public FragFactureExpress() {}
...
//                adapter.notifyDataSetChanged();
    ...
    private void setCommendList() {
        ...
        factures.add(new Facture(1, commends, new User(), new ShippingAddress(), Calendar.getInstance().getTime(), Utils.FactureState.EXPRESS));
        factures.add(new Facture(1, commends, new User(), new ShippingAddress(), Calendar.getInstance().getTime(), Utils.FactureState.EXPRESS));
        factures.add(new Facture(1, commends, new User(), new ShippingAddress(), Calendar.getInstance().getTime(), Utils.FactureState.EXPRESS));
        factures.add(new Facture(1, commends, new User(), new ShippingAddress(), Calendar.getInstance().getTime(), Utils.FactureState.EXPRESS));
        factures.add(new Facture(1, commends, new User(), new ShippingAddress(), Calendar.getInstance().getTime(), Utils.FactureState.EXPRESS));
