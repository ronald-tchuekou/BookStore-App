...
public class FragFactureObsoleted extends Fragment {
    List<Facture> factures;
    private ListView listView;
    private AdminCmdAdapter adapter;
    private View root;
    public FragFactureObsoleted() {}
    ...
    private void setCommendList() {
        ...
        factures.add(new Facture(1, commends, new User(), new ShippingAddress(), Calendar.getInstance().getTime(), Utils.FactureState.OBSOLETED));
        factures.add(new Facture(1, commends, new User(), new ShippingAddress(), Calendar.getInstance().getTime(), Utils.FactureState.OBSOLETED));
        factures.add(new Facture(1, commends, new User(), new ShippingAddress(), Calendar.getInstance().getTime(), Utils.FactureState.OBSOLETED));
        factures.add(new Facture(1, commends, new User(), new ShippingAddress(), Calendar.getInstance().getTime(), Utils.FactureState.OBSOLETED));
        factures.add(new Facture(1, commends, new User(), new ShippingAddress(), Calendar.getInstance().getTime(), Utils.FactureState.OBSOLETED));
